...
"""
    ...
    "matching_pair_announcement": "Доброе утро!\nСегодня социальный день, и в этот раз твой мэтч — {name}. Самое время написать друг другу и договориться о встрече — позавтракать вместе, выйти на прогулку, поковоркать, it's up to you.\nХорошего дня)",
    ...
    "weekly_reminder": (
        "Привет, завтра — день социального микродозинга. Хочешь приесоединиться?\n"
